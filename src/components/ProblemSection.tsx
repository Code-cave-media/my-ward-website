      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            ...
            Important information gets lost, voices go unheard, and
            neighborhoods become disconnected.
          </p>
        </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Critical community updates reach only a few, leaving many
                    residents uninformed about important decisions and events.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Citizens struggle to voice concerns or participate in local
                    governance due to lack of accessible communication channels.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Neighbors remain strangers, and community spirit weakens
                    without proper platforms for connection and collaboration.
                  </p>
                </div>
              </div>
            </div>
